    ...
    <section id='features'>
      <div className='container'>
        <h2 className='text-midnight_text text-center mb-5 max-w-xl mx-auto sm:leading-16'>
          3 Farklı Kimlik Bilgisi Toplama Yöntemi
        </h2>
        <p className='text-black/60 text-lg text-center md:max-w-[60%] mx-auto'>
          Pasistan cep telefonu uygulaması ile Kimlik bilgilerini alıp kaydetmek için; Misafiriniz geldiğinde siz tarayabilir, link gönderip misafirinizin kendisinin taramasını sağlayabilir ya da bilgi girişini elle cep telefonundan Pasistan uygulaması üzerinden yapabilirsiniz
        </p>
